            ...
            {selectedDateEvents.length === 0 && !hasError ? (
              ...
              selectedDateEvents.map((event) => {
                ...
                return (
                  <article
                    key={event.id}
                    className="overflow-hidden rounded-2xl border border-gray-200 bg-[#FFFFFF] shadow-sm"
                  >
                    ...
                    <div className="p-6">
                      ...
                      {!isFull && hasRsvpLink ? (
                        <a
                          ...
                          className="mt-6 block rounded-xl bg-[#0F6E00] py-4 text-center font-semibold text-white"
                        >
                          {buttonLabel}
                        </a>
                      ) : (
