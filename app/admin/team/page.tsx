...
export default function TeamPage() {
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = `pergas-team-${Date.now()}.csv`;
    a.click();
  };
  ...
  return (
    <div className="space-y-5 w-full pb-12">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[13px] mt-0.5 font-helvetica" style={{ color: '#939498' }}>
            Manage and verify all admin team records
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { label: 'Total Team',     value: stats.total,        accent: '#1a2e1a', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg> },
      ...
      <TableWrapper
        ...
        loading={loading}
        defaultPageSize={10}
        emptyState="No team members found matching your criteria."
      >
        <TableHead>
